...
import org.themarioga.game.util.BotCreationUtils;
...
public class WebhookBotServiceImpl implements BotService {
    ...
    public WebhookBotServiceImpl(String botToken, String botName, String webhookURL, String webhookCertPath, ApplicationService applicationService) {
